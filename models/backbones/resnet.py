...
def ResNet18(output_stride=32, BatchNorm=nn.BatchNorm2d, pretrained=False, in_c=3):
    """
...
def ResNet34(output_stride=32, BatchNorm=nn.BatchNorm2d, pretrained=True, in_c=3):
    """
    output, low_level_feat:
    512, 64
    """
...
def ResNet50(output_stride=32, BatchNorm=nn.BatchNorm2d, pretrained=True, in_c=3):
    """
    output, low_level_feat:
    2048, 256
    """
...
def ResNet101(output_stride=32, BatchNorm=nn.BatchNorm2d, pretrained=True, in_c=3):
    """
    output, low_level_feat:
    2048, 256
    """
...
class ResNet(nn.Module):
    ...
    def __init__(self,  block, layers, output_stride, BatchNorm, in_c=4):
